...
<body>
	<div id="layout1">
		<div id="centerCon" position="center" style="">
			...
			<form action="${path}/spotRelate/getNoRelatedWData" id="queryForm" method="post">
				<table align="center" style="width:100%;">
					<tr>
						<td style="width:10%;">安全提醒标题：</td>
						<td ><input type="text" id="eqName" name="eqName"  value=""  /></td>
						<td style="width:10%;">安全提醒内容：</td>
...
<script type="text/javascript">
	...
	function initGrid(){
		grid = $("#dataBasic").quiGrid({
		    ...
		    url: '${path}/spotRelate/getNoRelatedWData?spotId=${spotId }',rownumbers:true,checkbox:true,selectRowButtonOnly:false,
	...
	function addWar(refresh) {
	    ...
	    for(var i = 0 ; i < rowsLength ; i++ ){
	    	ids += ( rows[i].warning_id + "," );
	    }
	    $.ajax({
            cache: true,
            type: "POST",
            url:'${path}/spotRelate/doRelateWar',
            data:{"ids":ids,"spotId":"${spotId }"},
            async: false,
