...
<!--布局控件end-->
<script type="text/javascript" src="${path }/js/spotRelate/spotRelate.js"></script>
...
<body>
	<div id="layout1">
        <div id="leftCon" position="left" panelTitle="巡检点管理">
...
<!-- 			</div>   -->
        ...
        <div id="centerCon" position="center">
			<div class="padding_right5" style="height: 100%;">
				<iframe  style="width: 100% ;height: 100%;" frameborder="0"  id="spot-iframe"></iframe>
			</div>
        </div>
    </div> 
