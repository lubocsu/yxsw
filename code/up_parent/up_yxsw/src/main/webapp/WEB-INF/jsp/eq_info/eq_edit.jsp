		         	...
		         	<div class="task-detail">
		                 ...
		                 <table class="detail-list">
	                    	...
	                    	<tr>
	                    		<th>备注:</th>
				    			<td colspan="3">
				    				<textarea name="remark" id="remark" maxnum="500">${sbInfo.remark}</textarea>
				    			</td>
	                    	</tr>
			    	...
			    	<div class="task-detail">	
		        		...
		        		<table class="detail-list">
				    		<tr>
				    			<th>设备原值:</th>
				    			<td>
				    				<input type="text" name="startValue" id="startValue" value="${sbInfo.startValue}" class="validate[length[0,50],custom[onlyNumberDot2]]"/>
				    			</td>
				    			<th>最近评估现值:</th>
				    			<td>
				    				<input type="text" name="zjpgValue" id="zjpgValue" value="${sbInfo.zjpgValue}" class="validate[length[0,50],custom[onlyNumberDot2]]"/>
				    			</td>
				    		</tr>
				    		<tr>
				    			<th>开始使用日期:</th>
