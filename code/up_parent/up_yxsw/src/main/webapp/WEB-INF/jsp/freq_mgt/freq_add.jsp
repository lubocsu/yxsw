		...
		<div class="list-content">
	    	 <div class="details-container">
                <form action="${path}/freq/saveFreq" id="form">
		                ...
		                <div class="to_hide_over_content" class="text">
	                 	...
	                 	<table class="detail-list">
		                 	<tr>
				    			...
				    			<td>
				    				<input type="text" name="freqSegmentName" id="freqSegmentName" class="validate[required,length[0,42]]" value="${freqSegmentName }" style="width: 253px;" />
				    			</td>
		                    ...
		                    <tr>
		                        ...
		                        <td>
		                        	...
		                        	<input type="text" class="date validate[required]" name="startTime" id="startTime"  value="${startTime }" disabled="disabled" style="width:253px" readonly="readonly" onFocus="WdatePicker({skin:themeColor,dateFmt: 'HH:mm',isShowClear:true, onpicked:vlpick})" />
								...
								<td>
									...
									<input type="text" class="date validate[required]" name="endTime" id="endTime"  value="${endTime }" disabled="disabled" style="width:253px" readonly="readonly" onFocus="WdatePicker({skin:themeColor,dateFmt:'HH:mm',isShowClear:true, onpicked:vlpick})" />
	            	...
	            	<!-- 关联设备设施 start -->
		            <div class="task-audit" style="display: none;" id="freq_detail">
						...
						<div class="detail-list">
							<div  class="basicTab" style="background-color: rgb(241, 244, 255);"  iframeMode="true" 
								data='{"list":[{"name":"巡检设备","url":"${path }/freq/toFreqEpList?freqId=${BizTXjdItem.xjdItemId }"},
						      			{"name":"巡检设施","url":"${path }/freq/toFreqSsList?freqId=${BizTXjdItem.xjdItemId }"}]}'>
