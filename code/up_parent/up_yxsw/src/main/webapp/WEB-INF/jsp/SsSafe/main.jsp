...
<!--布局控件end-->
<%-- <script type="text/javascript" src="${path }/js/ssattachsb/main.js"></script> --%>
<script type="text/javascript" src="${path }/js/sssafe/main.js"></script>
...
<body>
	<div id="layout1">
        <div id="leftCon" position="left" panelTitle="设施安全提醒关联配置">
