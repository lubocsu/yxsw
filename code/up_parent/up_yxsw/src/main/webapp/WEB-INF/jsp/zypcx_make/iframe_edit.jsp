...
<body>
	<div class="basicTab" style="height: 100%;" iframeMode="true" 
				data='{"list":[{"name":"作业票详情","url":"${path }/zypcxMake/toEdit?cxMakeId=${cxMakeId}"},
	...
	<div class="list-btm">
	  	<div class="list-btm-div">
	        <div class="div-btn-sbt">
				<button class="btm-button oksubmitButton" type="button"  onclick="saveAndSubmit(1);"><span class="ok-icon">保存</span></button>
				<button class="btm-button oksubmitButton" type="button"  onclick="saveAndSubmit(2);"><span class="ok-icon">保存并提交</span></button>
