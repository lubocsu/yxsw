...
<script type="text/javascript" src="${path }/js/eqSelect/eqSelect.js"></script>
        ...
        <div id="leftCon" position="left" panelTitle="设备检查项关联配置">
			...
			<div class="searchBox" style="padding-left: 5px;padding-top: 1px;">
				<input type="text" style="width:85%;" watermark="输入关键字"  id="searchTree"/>
				 <div style="width: 11%;padding-top: 4px;float: right;">
				<span class="img_find hand" title="点击查找节点" keepdefaultstyle="true" onclick="searchTree1()"></span>
				</div>
			</div> 
        	<div class="orgTreeContainer" style="padding: 30px 5px;">
        		<ul id="tree" class="ztree"></ul>
        	</div>
        </div>
        <div id="centerCon" position="center">
			<div class="padding_right5" style="height: 100%;">
				<iframe  style="width: 100% ;height: 100%;" frameborder="0"  id="eq-detail-iframe"></iframe>
			</div>
        </div>
    </div> 
...
<script type="text/javascript">
	...
	function refresh(parentId){
		Equipment.refreshTree(parentId);
	}
	
	 function getValue(){
		//value1=document.getElementById("#searchTree").value;
		value1=$("#searchTree").val();
		console.log(value1);
