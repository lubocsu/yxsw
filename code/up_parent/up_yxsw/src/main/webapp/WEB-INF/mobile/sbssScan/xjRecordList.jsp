	            ...
	            success: function (appresult) {
	                ...
	                if(flag){
	                	...
	                	for(var i in xjRecordList){
	                		...
	                		equipmentStatusList += '<tr><th>是否有问题：</th><td  style="width:70%;">'+(xjRecordList[i].sf_fault!=null?xjRecordList[i].sf_fault:"--")+'</td></tr>';
	                		equipmentStatusList += '<tr><th>操作人：</th><td>'+(xjRecordList[i].person_name!=null?xjRecordList[i].person_name:"--")+'</td></tr>';
