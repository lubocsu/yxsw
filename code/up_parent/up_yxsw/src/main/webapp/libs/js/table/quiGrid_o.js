/*
 * 从加密文件还原，修复quiGrid editer模式下date类型dateFmt参数无效的bug；
 * - 2017.09.16 cc
 * */
    ...
    $.quiDefaults.Grid.editors.textarea = {
        create: function(container, editParm) {
            if ((eval(uncompile("u%CC%D9%C8%CD%E9%D5%AB%B2%CD%C8%CC%8DQ"))) == "r%C8%D0%D9%D3%CB%C3%CF%D0%C7%D3") {
                ...
                if (column.editor.maxnum) {
                    input.attr("maxnum",column.editor.maxnum);
                }
...
//                    dateFormat = input.attr("dateFmt")
                	dateFormat = column.editor.dateFmt
                }
                var doubleCal = false;
    ...
    $.quiDefaults.Grid.editors.select = {
        create: function(container, editParm, g, p) {
            if ((eval(uncompile("u%CC%D9%C8%CD%E9%D5%AB%B2%CD%C8%CC%8DQ"))) == "r%C8%D0%D9%D3%CB%C3%CF%D0%C7%D3") {
                ...
                input.attr("prompt", uncompile(quiLanguage.quiGrid.editorPromptMessage));
                if (column.editor.detailEdit == true) {
                    container.width("auto").height(30)
                } else {
                    container.height("auto")
    ...
    $.quiui.controls.Grid.quiExtend($.quiui.core.UIComponent, {
        ...
        loadData: function(loadDataParm, detailRemory) {
            ...
            var clause = null;
            var loadServer = true;
            if (getTypeFlage() != "r%C8%D0%D9%D3%CB%C3%CF%D0%C7%D3") {
                return
            }
