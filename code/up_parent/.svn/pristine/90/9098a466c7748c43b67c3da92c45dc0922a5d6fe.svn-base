	         	...
	         	<div class="task-detail">
	                 ...
	                 <div class="to_hide_over_content" class="text">
		                 ...
		                 <table class="detail-list" >
		                 	<tr>
		                 		<th style="width:10%;"><span><em style="color:red;">*</em></span>指标项编码：</th>
		                 		<td><input class="validate[required,length[0,32],custom[noSpecialCaracters]
	],ajax[${path }/indicative/validLoginId|* 输入指标项code重复]]" name="cxzb_code" id="cxzb_code" type="text"  style="width:200px;"/></td>
		                 		...
		                 		<!-- <td><input type="text" id="responsobility" name="responsobility" class="validate[length[0,32]]" value=""  style="width:200px;"/></td> -->
		                 			<td><input class="validate[required,length[0,128]]" name="cxzb_name" id="cxzb_name" value="" type="text"  style="width:200px;"/></td>
		                 	</tr>
		                 	<tr>
		                 		<th>计量单位：</th>
		                 		<td><select labelField="value" valueField="key"  selWidth="200"  name="cxzb_unit" id="cxzb_unit" prompt="请选择" selectedValue="" url="${path}/platform/getSupportData" params='{"parentNodeId":"UM000007"}'></select></td>
		                 		<th style="width:10%;"><em style="color:red;">*</em>输入类型：</th>
		                 		<td ><select labelField="value" valueField="key" class="validate[required]"  type="inputlxs"  selWidth="200"  name="cxzb_tblx" id="cxzb_tblx" prompt="请选择" selectedValue="" url="${path}/platform/getSupportData" params='{"parentNodeId":"UM000015"}'></select></td>
		                 	</tr>
		                 	
		                 	<tr>
								<th>说明：</th>
								<td colspan="3">
									<textarea maxNum="300" name="cxzb_desc" class="validate[required,length[0,300]]" id="textarea" style="width:70%;height:110px;"/></textarea>
								</td>
							</tr>
		                 </table>
	            	</div>
