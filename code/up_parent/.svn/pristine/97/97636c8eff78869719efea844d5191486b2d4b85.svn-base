		                ...
		                <div class="to_hide_over_content" class="text">
	                 	...
	                 	<table class="detail-list">
		                 	<tr>
				    			...
				    			<td>
				    				<input type="text" name="zxpTempItmName" id="zxpTempItmName" class="validate[required,length[0,42]]" value="${zxpTempItm.zxpTempItmName }" style="width: 253px;" />
				    			</td>
		                 		<th></th>
		                 		<td></td>
		                 	</tr>
		                 	<tr>
				    			...
				    			<td class="cb">
				    				<span>
					    				<input type="checkbox" name="jlxdz" id="jlxdz" value="1" /><label for="jlxdz">记录下达值</label>
					    				<input type="checkbox" name="jlsbz" id="jlsbz" value="1" /><label for="jlsbz">记录完成值</label>
					    				<input type="checkbox" name="jlqcl" id="jlqcl" value="1" /><label for="jlqcl">记录去除率</label>
				    				</span>
				    			</td>
		                 	</tr>
		                    <tr>
		                        <th>说明：</th>
				    			<td colspan="3">
				    				<textarea name="confDesc" id="confDesc" maxNum="500" style="width:82%;" >${zxpTempItm.confDesc }</textarea>
				    			</td>
		                    </tr>
		                 </table>
	            	</div>
