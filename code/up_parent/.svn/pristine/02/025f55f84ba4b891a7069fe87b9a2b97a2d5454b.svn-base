	                 ...
	                 <div class="to_hide_over_content" class="text">
		                 ...
		                 <table class="detail-list" >
		                 	<tr>
		                 		...
		                 		<td><input disabled="disabled" class="validate[required,length[0,32],custom[noSpecialCaracters]
		                 	...
		                 	<tr>
		                 		...
		                 		<td ><select labelField="value" valueField="key" selWidth="200" name="cxzb_tblx" id="cxzb_tblx" class="validate[required]" disabled="disabled" prompt="请选择" selectedValue="${cxzb_id.cxzb_tblx }" url="${path}/platform/getSupportData" params='{"parentNodeId":"UM000015"}'></select></td>
		                 	</tr>
		                 	
		                 	<tr>
								<th>说明：</th>
								<td colspan="3">
									<textarea maxNum="300" name="cxzb_desc" class="validate[required,length[0,300]]"   style="width:70%;height:110px;"/>${cxzb_id.cxzb_desc }</textarea>
								</td>
							</tr>
		                 </table>
	            	</div>
