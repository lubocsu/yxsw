...
<script type="text/javascript" src="${path }/js/SbSafe/main.js"></script>
...
<body>
	<div id="layout1">
        <div id="leftCon" position="left" panelTitle="设备安全提醒关联配置">
        ...
        <div id="centerCon" position="center">
			<div class="padding_right5" style="height: 100%;">
				<iframe  style="width: 100% ;height: 100%;" frameborder="0"  id="SbSafe-detail-iframe"></iframe>
			</div>
        </div>
    </div> 
