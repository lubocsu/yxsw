		...
		<div id="centerCon" position="center" style="">
			...
			<input type="hidden" id="initEndTime" value="${initEndTime }" />
			  ...
			  <table class="detail-list" >
					...
					<td  style="width:15%;text-align:left"><input type="text" id="code" onkeydown="if(event.keyCode==13){return false;}" class="input119" name="code" value="${title }"/></td>
	...
	function initGrid(params){
		...
		grid = $("#dataBasic").quiGrid({
			columns:[	
				   ...
				   url: '${path}/sbWarn/getUnCheckList?sbId='+sbidsbid ,
		    params:params,
		    rownumbers:true,
		    checkbox:true,
