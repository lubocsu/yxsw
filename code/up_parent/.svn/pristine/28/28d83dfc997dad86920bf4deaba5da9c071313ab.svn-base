    ...
    var PhotoBrowser = function (params) {
        ...
        var navbarTemplate = pb.params.navbarTemplate ||
                            '<header class="bar bar-nav">' +
                              '<a class="icon icon-left pull-left photo-browser-close-link' + (pb.params.type === 'popup' ?  " close-popup" : "") + '" style="margin-top:0.25rem;font-size:0.7rem">返回</a>' +
        ...
        var toolbarTemplate = pb.params.toolbarTemplate ||
                            '<nav class="bar bar-tab" style="background:#f7f7f8;">' +
