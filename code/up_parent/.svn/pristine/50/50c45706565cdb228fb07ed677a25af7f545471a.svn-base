...
<body>
	<input type="hidden" id="relateId" value="${roleId}">
	<div align="center" style="margin-top:10px;font-size: 22px; font-weight: bold;">角色[<span style="color: #daa047;">${roleName}</span>]的数据权限</div>
...
<script type="text/javascript" src="${path }/js/permissiondata/rolePermissionDataTree.js"></script>
<script type="text/javascript">
var zTree=null;
