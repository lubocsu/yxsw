	...
	<form id="myFormId" action="${path }/dict/addDict" method="post" target="frmright">
		<table class="tableStyle" formMode="transparent">
			<tr>
				<td>字典名称：</td>
				<td colspan="3">
					<input type="text" name="treeDescription" class="validate[required,length[0,16]"  style="width:352px;"/>
			...
			<tr>
				<td>字典类型：</td>
				<td>
					<select prompt="请选择" name="treeType" class="validate[required]" url="${path }/dict/findDictItems?treeId=${dict.DICT_TYPE }" id="treeType" selectedValue="2"></select>
					<span class="star">*</span>
				</td>
				<td>限制级别：</td>
				<td>
					<select prompt="请选择" name="levelLimit" class="validate[required]" url="${path }/dict/findDictItems?treeId=${dict.DICT_LIMIT }" id="levelLimit" selectedValue="0"></select>
					<span class="star">*</span>
				</td>
			</tr>
			<tr>
				<td>排序号：</td>
				<td colspan="3">
					<input type="text" name="OrderNo" class="stepper validate[custom[onlyNumber]]" value="${defaultNo }" min="1" max="9999" style="width:352px;"/>
				</td>
			</tr>
			<tr>
				<td>备注：</td>
				<td colspan="3">
					<textarea name="remark" maxNum="200" class="validate[length[0,200]]" style="width:352px; height:50px;"></textarea>
				</td>
			</tr>
		</table>
	</form>
