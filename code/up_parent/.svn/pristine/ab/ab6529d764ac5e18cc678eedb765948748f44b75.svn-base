...
<body>
	<div class="basicTab" style="height: 100%;" iframeMode="true" 
				data='{"list":[{"name":"作业票详情","url":"${path }/zypReceive/detail?cxMakeId=${cxMakeId}"},
	  	...
	  	<div class="list-btm-div">
	        <div class="div-btn-sbt">
	        	<c:if test="${csOrgType eq '3'}">
	        		<button id="okButton" class="btm-button" type="button"  onclick="zypReceive();"><span class="ok-icon">提交</span></button>
	        	</c:if>
